# Cyclone Path & Intensity Prediction

A deep learning project that predicts cyclone tracks (latitude & longitude) and intensity (maximum wind speed) using an LSTM-based model.
The project is deployed with Streamlit and provides an interactive interface for users to input cyclone data and visualize predictions on an interactive map.
